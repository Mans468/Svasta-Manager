...
export const REUNIONS_INITIALES: Reunion[] = [
    ...
    { id: "2", titre: "Suivi Jean Malik", type: "Spéciale", lieu: "Bureau de l'Administrateur", jour: "Aujourd'hui", heure: "17:00-18:00", presenceObligatoire: false, residentConcerneId: "4" },
